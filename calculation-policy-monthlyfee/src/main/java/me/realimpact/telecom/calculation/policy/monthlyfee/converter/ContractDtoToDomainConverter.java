package me.realimpact.telecom.calculation.policy.monthlyfee.converter;

import me.realimpact.telecom.calculation.domain.monthlyfee.*;
import me.realimpact.telecom.calculation.policy.monthlyfee.domain.*;
import me.realimpact.telecom.calculation.policy.monthlyfee.domain.FlatRatePolicy;
import me.realimpact.telecom.calculation.policy.monthlyfee.dto.ChargeItemDto;
import me.realimpact.telecom.calculation.policy.monthlyfee.dto.ContractProductsSuspensionsDto;
import me.realimpact.telecom.calculation.policy.monthlyfee.dto.ProductDto;
import me.realimpact.telecom.calculation.policy.monthlyfee.dto.SuspensionDto;
...
//            // flat
//            case "FLAT" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.FlatRatePolicy(
//                    dto.getFlatRateAmount()
//            );
//            case "01" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.MatchingFactorPolicy(
//                java.util.List.of() // 빈 매칭 규칙 리스트
//            );
//            case "02" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.RangeFactorPolicy(
//                "default", // 임시 기본값
//                java.util.List.of() // 빈 범위 규칙 리스트
//            );
//            case "03" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.UnitPriceFactorPolicy(
//                "count", // 임시 기본값
//                    dto.getFlatRateAmount()
//            );
//            case "04" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.StepFactorPolicy(
//                "count", // 임시 기본값
//                java.util.List.of() // 빈 구간 규칙 리스트
//            );
//            case "05" -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.TierFactorPolicy(
//                "count", // 임시 기본값
//                java.util.List.of() // 빈 구간 규칙 리스트
//            );
//            default -> new me.realimpact.telecom.calculation.policy.monthlyfee.domain.FlatRatePolicy(
